"""
Django settings for smartlib_backend project.
...
SECRET_KEY = 'django-insecure-bl71f72t022acet)=rc%)av1ewnx!mpj^f*lwd*aql_q^r8nn^'
...
ROOT_URLCONF = 'smartlib_backend.urls'
...
WSGI_APPLICATION = 'smartlib_backend.wsgi.application'
...
# CORS: фронтенды (Next.js :3000, Vite :5173). Список через запятую в .env — см. .env.example
